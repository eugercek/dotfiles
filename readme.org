...
#+begin_src sh
sudo dnf install $(cat ./packages/dnf-packages)
#+end_src
*** packages
:PROPERTIES:
...
#+begin_src sh
flatpak install $(cat ./packages/flatpak-packages)
#+end_src
*** packages
:PROPERTIES:
...
#+begin_src sh
sudo snap install $(cat ./packages/snap-packages)
#+end_src
*** pakcages
:PROPERTIES:
...
#+begin_src sh
dnf install $(cat ./packages/pip-packages)
#+end_src
*** packages
:PROPERTIES:
