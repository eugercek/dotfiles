...
#+END_SRC
*** Subscript and Superscrip
If really want to dispaly inline in org mode use _{} syntax
#+begin_src emacs-lisp
...
#+end_src
*** Smoother blocks begin and end lines
You can use ~(org-faces)~ =SPC F= to search faces.
#+begin_src emacs-lisp
(custom-set-faces!
...
#+end_src
*** Increase Expoted Headline Level
#+begin_src emacs-lisp
...
*** emacs
**** dired
Look at files continuously like ranger.
#+BEGIN_SRC emacs-lisp
(map!
 (:after dired
  (:map dired-mode-map
...
#+END_SRC
*** info-colors
Make info more readable with syntax higlight at least for elisp.
#+BEGIN_SRC emacs-lisp
