...
** Theme
#+begin_src emacs-lisp
(defun eug/apply-theme-changes ()
  "TODO"
  (cond ((eq doom-theme 'doom-one-light )
         (custom-set-faces!
           '(region    :background "#F2F5FF")
           '(org-block :background "#fdfdfd")))))
...
(use-package! erc
  ...
  (setq erc-autojoin-channels-alist '(("libera.chat" "#test"))
        erc-autojoin-timing 'ident)

  (setq erc-fill-column 100
        erc-fill-function 'erc-fill-static ;; How 2nd line of message will be shown
        erc-fill-static-center 0)           ;; Prefix space before username)
...
** Connect to IRC
#+begin_src emacs-lisp
(defun eug/count-emacs-instances ()
  "Return number of emasc instances.
Not frames!"
  (string-to-number
   (shell-command-to-string
    "ps -C emacs --no-headers | wc -l")))

(when (eq 1 (eug/count-emacs-instances))
  (progn (message "I'm in")
         (erc-tls
          :server erc-server
          :port 6697
          :nick irc-nick
