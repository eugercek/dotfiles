...
// https://github.com/brookhong/Surfingkeys/blob/master/src/content_scripts/common/api.js#L132
...
// ----- Handle collision of video specific keybindings and Surfingkeys -----

let videoBlockedKeys = new RegExp(blockSites.join("|"), "i");
let youtubeBlockedKeys = new RegExp(blockSites.join("|"), "i");

videoKeys.forEach((i) => key(alt_key(i), i, videoBlockedKeys));
youtubeKeys.forEach((i) => key(alt_key(i), i, youtubeBlockedKeys));
...
mapkey(";n", "Go to next episode", function next_episode() {
